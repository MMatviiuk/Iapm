...
export default function AddPrescriptionEnhanced({ 
  darkMode, 
  setCurrentPage, 
  addMedication 
}: AddPrescriptionEnhancedProps) {
  ...
  // Auto-save draft
  useEffect(() => {
    const draftKey = 'medication_draft';
    ...
    if (savedDraft && formData.name === '') {
      try {
        ...
        setMedicationImage(parsed.image);
  ...
  }, [formData, medicationImage, currentStep]);
  ...
  // Times per day selection with FIFO
  ...
  const handleSubmit = () => {
    ...
    // Clear draft
    localStorage.removeItem('medication_draft');
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-sm opacity-75">8:00 AM</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-sm opacity-75">1:00 PM</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-sm opacity-75">7:00 PM</span>
                  </button>
                </div>
                {errors.timeOfDay && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-2">
            ...
            <div className="space-y-5">
              ...
              <div>
                <FieldWithTooltip
                  ...
                  tooltip="<strong>Choose which days</strong> you need to take this medication.<br/><br/><strong>Quick options:</strong><br/>• All Days: Every day of the week<br/>• Weekdays: Monday to Friday only<br/>• Weekends: Saturday and Sunday only<br/>• Custom: Tap individual days below<br/><br/>💡 Some medications are only needed on specific days (e.g., weekly supplements on Sundays)."
                  required={true}
                  darkMode={darkMode}
                  className="mb-3 block"
                />
          ...
          >
            <div className="text-center mb-6">
              ...
              <p className={`text-base lg:text-lg ${
                ...
                {formData.name ? `Review details for ${formData.name}` : 'Please review your medication details'}
              </p>
            </div>
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <Button
            onClick={() => {
              if (currentStep === 1) {
                const hasData = formData.name || medicationImage;
                if (hasData) {
