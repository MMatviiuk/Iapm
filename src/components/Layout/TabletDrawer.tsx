    ...
    switch (userRole) {
      case 'caregiver':
        return {
          ...
          active: 'bg-orange-50 dark:bg-orange-950/30 text-orange-600 dark:text-orange-400 border-l-4 border-orange-600',
        };
      case 'doctor':
        return {
          bg: 'bg-purple-600',
          ...
          active: 'bg-purple-50 dark:bg-purple-950/30 text-purple-600 dark:text-purple-400 border-l-4 border-purple-600',
        };
      default:
        return {
          bg: 'bg-blue-600',
